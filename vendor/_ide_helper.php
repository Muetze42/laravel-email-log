...
namespace NormanHuth\LaravelEmailLog\Models{
    /**
     * NormanHuth\LaravelEmailLog\Models\EmailLog
     *
     * @property int $id
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog whereAuthenticatableId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog whereAuthenticatableType($value)
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog whereBbc($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog whereDeletedAt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog whereIsHtml($value)
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog wherePriority($value)
     * @method static \Illuminate\Database\Eloquent\Builder|EmailLog whereReplyTo($value)
